...
class PreparationTemplatePhase {
  ...
  factory PreparationTemplatePhase.fromJson(
    Map<String, dynamic> j,
  ) => PreparationTemplatePhase(
    key: j['key'] as String,
    title: j['title'] as String,
    weight: (j['weight'] as num).toDouble(),
    requiredTasks: (j['required_tasks'] as List)
        .map((e) => PreparationTemplateTask.fromJson(e as Map<String, dynamic>))
        .toList(),
