  ...
  static List<_Fixture> _buildFixtures() => [
    ...
    _Fixture(
      professor: const Professor(
        ...
        bio:
            '北航软件学院教授、硕士生导师，研究人工智能与模式识别、多模态大模型、计算机视觉、具身智能、大数据技术和智能软件工程。关注多模态信息融合、云边端协同智能系统、医学影像三维重建、智慧交通、工业智检和智能制造。',
        homepageUrl:
    ...
    _Fixture(
      professor: const Professor(
        ...
        bio:
            '北航软件学院教授、博士生导师，长期从事数字孪生、数字工程、智能制造和制造工业软件研究。主持和参与智能制造相关重点研发工作，出版多部专著，在 Nature 等期刊发表多篇高被引论文，带领团队获得国家科技进步二等奖等成果。',
        homepageUrl:
    ...
    _Fixture(
      professor: const Professor(
        ...
        bio:
            '北航网络空间安全学院教授、硕士生导师，研究去中心化人工智能、应用密码学、分布式系统安全、数据安全与隐私、区块链和数字货币。公开主页显示其长期从事密码学、信息安全、隐私保护及 AI 安全方向研究。',
    ...
    _Fixture(
      professor: const Professor(
        ...
        bio:
            '南京大学智能软件与工程学院助理教授、博士生导师，研究软件测试、故障定位、软件分析和基础软件测试与分析。长期关注组合测试故障定位理论与方法，在 TSE、TOSEM、ICSE、FSE、ICST 等软件工程期刊会议发表论文，成果已在企业应用。',
    ...
    _Fixture(
      professor: const Professor(
        ...
        bio:
            '南京大学智能软件与工程学院教授、博士生导师，教学与科研工作涉及软件工程、可信软件和形式化方法。曾任南京大学计算机科学与技术系系主任、软件学院院长，兼任中国计算机学会软件工程专业委员会主任等职务。',
    ...
    _Fixture(
      professor: const Professor(
        ...
        bio:
            '南京大学智能软件与工程学院助理教授、博士生导师，研究数据中心网络、网络传输协议和机器学习系统。以第一或通讯作者在 USENIX NSDI、IEEE INFOCOM、IEEE/ACM TON 等会议期刊发表论文，多次担任国际会议程序委员会成员。',
    ...
    _Fixture(
      professor: const Professor(
        ...
        bio:
            '南京大学能源与资源学院准聘副教授、博士生导师，关注物质架构原理，利用图论和人工智能等前沿技术开展材料的大规模设计、精准构筑与能源应用研究。曾在海外高校和研究机构完成博士、博士后及研究科学家训练。',
    ...
    _Fixture(
      professor: const Professor(
        ...
        bio:
            '南京大学法学院助理教授，研究数字经济、知识产权、科技治理、技术成果转化和人工智能监管。曾在北京大学相关研究机构从事信息技术、健康人文与人工智能法方向研究工作，兼任中国科学技术法学会人工智能法专业委员会相关职务。',
    ...
    _Fixture(
      professor: const Professor(
        ...
        bio:
            '电子科技大学教授、博士生导师，长期从事智能功率集成电路与系统、高效电源管理、模拟集成电路抗辐射加固、能量采集和低功耗数模混合集成技术研究。主持国家重大专项、自然科学基金等项目，发表论文并授权多项发明专利。',
    ...
    _Fixture(
      professor: const Professor(
        ...
        bio:
            '电子科技大学集成电路科学与工程学院教授、博士生导师，研究复杂环境下在线测量方法与仪器、高温高动态测量、热电制冷材料及元器件。主持国家自然科学基金面上项目、国家测试仪器工程产品替代研制项目等多项课题。',
    ...
    _Fixture(
      professor: const Professor(
        ...
        bio:
            '电子科技大学自动化工程学院副研究员，研究新能源系统及控制技术、系统工程与智能装备、故障诊断与健康管理、模式识别与机器学习。主持四川省科技支撑计划和中科院西部之光项目，关注燃料电池智能化算法与寿命预测。',
    ...
    _Fixture(
      professor: const Professor(
        ...
        bio:
            '电子科技大学信息与通信工程学院教授、博士生导师，研究统计信号处理、数字信号处理、人工智能及其在雷达、通信和医学中的应用。曾任 IEEE 信号处理学会相关专委会和期刊编委，获得 IET 国际雷达会议最佳论文等奖项。',
    ...
    _Fixture(
      professor: const Professor(
        ...
        bio:
            '电子科技大学信息与软件工程学院教授、博士生导师，研究软件理论、网络安全与网络工程、云计算与大数据、智能计算。长期从事计算机教学与科研，参与和主持多项国家重点科技攻关、863、省部级和网络安全相关项目。',
    ...
    _Fixture(
      professor: const Professor(
        ...
        bio:
            '电子科技大学自动化工程学院教授、博士生导师，长期从事群体智能机理、多智能体系统协同控制、无人集群系统智能感知与协同定位研究。发表学术论文百余篇，授权发明专利多项，主持国家自然科学基金等项目。',
